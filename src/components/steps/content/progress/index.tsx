	...
	return (
		<>
			<motion.div variants={textAnimation}>
				<Text classes="text-lg md:text-3xl font-semibold">Meno teoria</Text>
			</motion.div>

			<motion.div variants={textAnimation}>
				<Text classes="text-xl md:text-4xl font-semibold uppercase text-indigo-700">
					tanta pratica
				</Text>
			</motion.div>

			<motion.div variants={textAnimation}>
				<Text classes="text-lg md:text-3xl font-semibold">
					per trovare da subito un lavoro specializzato e ben retribuito
				</Text>
			</motion.div>
			...
			<motion.div variants={textAnimation}>
				<Text classes="text-xl md:text-4xl text-indigo-700 font-semibold">
					Più di un 1/3 del percorso è svolto in azienda
				</Text>
			</motion.div>
