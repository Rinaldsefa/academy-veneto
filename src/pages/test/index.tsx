  ...
  results: [
    {
      id: 0,
      name: "Moda",
      image: "/assets/courses/bullet/moda.png",
      href: "/corsi/moda",
    },
    {
      id: 1,
      name: "Turismo",
      image: "/assets/courses/bullet/turismo.png",
      href: "/corsi/turismo",
    },
    {
      id: 2,
      name: "Agroalimentare",
      image: "/assets/courses/bullet/agroalimentare.png",
      href: "/corsi/agroalimentare",
    },
    {
      id: 3,
      name: "Mobilità sostenibile (logistica)",
      image: "/assets/courses/bullet/mobilità.png",
      href: "/corsi/mobilita-sostenibile",
    },
    {
      id: 4,
      name: "Efficienza energetica",
      image: "/assets/courses/bullet/efficienza-energetica.png",
      href: "/corsi/efficienza-energetica",
    },
    {
      id: 5,
      name: "Design e arredo",
      image: "/assets/courses/bullet/design-e-arredo.png",
      href: "/corsi/design-e-arredo",
    },
    {
      id: 6,
      name: "Meccanica, meccatronica, informatica industriale",
      image: "/assets/courses/bullet/meccanica.png",
      href: "/corsi/meccanica-e-meccatronica",
    },
    {
      id: 7,
      name: "Servizi alle imprese",
      image: "/assets/courses/bullet/servizi-alle-imprese.png",
      href: "/corsi/servizi-alle-imprese",
    },
    {
      id: 8,
      name: "Information Technologies",
      image: "/assets/courses/bullet/information-technologies.png",
...
export default function Test() {
  ...
  const calculatePercentage = () => {
    const totalPossiblePoints = test.questions.length;
    const resultPercentages = {};

    for (const [key, value] of Object.entries(results)) {
      resultPercentages[key] = (value / totalPossiblePoints) * 100;
    }
  ...
  useEffect(() => {
    if (isCompleted) {
      const indexes = getTop3ResultsIndexes();

      const event = {
        event: "test_completato",
        risultato_1: test.results[indexes[0].id].name,
        risultato_1_valore: calculatePercentage()[indexes[0].id].toFixed(1),
        risultato_2: test.results[indexes[1].id].name,
        risultato_2_valore: calculatePercentage()[indexes[1].id].toFixed(1),
        risultato_3: test.results[indexes[2].id].name,
        risultato_3_valore: calculatePercentage()[indexes[2].id].toFixed(1),
      };
        ...
        <main className="flex-1 py-8 overflow-y-scroll w-full sm:max-w-2xl flex-grow mx-auto text-center">
          ...
          {isLoadingResult ? (
            ...
            <div className="mx-auto mt-4 max-w-xl">
              ...
              abilità, interessi e aspirazioni sono i seguenti:{" "}
              <div className="mt-8 mx-4 md:mx-0 grid grid-cols-1 md:grid-cols-3 gap-3">
                {getTop3ResultsIndexes().map((result, index) => (
                  <Link key={index} href={test.results[result.id].href}>
                    <div className="bg-white rounded-lg h-full shadow-lg py-8 px-6 gap-4 flex flex-col text-center justify-between">
                      <div>
                        <p className="text-primary font-bold mb-2">
                          {calculatePercentage()[result.id].toFixed(1)}%
                        </p>

                        <h3 className="leading-6 drop-shadow text-lg">
                          {test.results[result.id].name}
                        </h3>
                      </div>

                      <img
                        src={test.results[result.id].image}
                        alt=""
                        className="mt-4"
                      />
                    </div>
