              ...
              >
                ...
                {degree.bulletPoints.map((bulletPoint, i) => (
                  ...
                  >
                    ...
                    {bulletPoint.provinces.map((province) => (
                      <section
                        key={province.province}
                        className="flex flex-col justify-center gap-2 w-full max-w-screen-xl my-4"
                      >
                        <strong className="font-semibold md:text-2xl md:text-center">
                          {province.province}
                        </strong>
                        <ul className="flex flex-col md:flex-row md:flex-wrap gap-2 md:gap-4 justify-center md:items-center">
                          {province.list.map((listItem) => (
                            <li
